...
define('SECRET_SALT','yf3FwO1pm9tuC3Hrchkr5JqUhtrXO2b1');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','deepakp@numerictech.com');
...
define('DBNAME','numerichelpdesk');
define('DBUSER','numeric');
define('DBPASS','numeric');
